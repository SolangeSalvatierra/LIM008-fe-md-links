...
exports.getMDContent = exports.contenFileMD = exports.validateExtMD = exports.routeIsFile = exports.routeIsDirectory = exports.transformToAbsPath = exports.evaluatePath = void 0;

let path = require('path');

const fs = require('fs');

const myMarked = require('marked'); // const pathAbsMD = 'C:\\Users\\Maria Paula\\Desktop\\markdown\\README.md';
...
const routeIsDirectory = pathAbs => {
  return fs.lstatSync(pathAbs).isDirectory();
};

exports.routeIsDirectory = routeIsDirectory;
console.log(routeIsDirectory('D:\PROYECTOS-solange\Markdown-Links'));

const routeIsFile = pathAbs => {
...
exports.routeIsFile = routeIsFile;
...
exports.contenFileMD = contenFileMD;

const getMDContent = arrMD => {
  let arrLinks = [];
  arrMD.map(routeMD => {
